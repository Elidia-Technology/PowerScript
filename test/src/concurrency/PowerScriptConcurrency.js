...
import { QueueType, ConcurrencyError, EventType } from './types.js';
export class PowerScriptConcurrency extends EventEmitter {
     ...
     */
    createQueue(queueId, type = QueueType.FIFO, options = {}, name) {
    ...
    async retry(task, maxAttempts = this.config.retryAttempts, delay = this.config.retryDelay) {
        ...
        throw new ConcurrencyError(`Task failed after ${maxAttempts} attempts: ${lastError.message}`, 'RETRY_EXHAUSTED');
    }
    // ============================================================================
