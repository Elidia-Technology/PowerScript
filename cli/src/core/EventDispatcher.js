...
EventTypes.ADDED_TO_STAGE = 'addedToStage';
EventTypes.REMOVED = 'removed';
EventTypes.REMOVED_FROM_STAGE = 'removedFromStage';
EventTypes.ENTER_FRAME = 'enterFrame';
EventTypes.RESIZE = 'resize';
EventTypes.COMPLETE = 'complete';
...
EventTypes.MOUSE_OVER = 'mouseOver';
EventTypes.MOUSE_OUT = 'mouseOut';
EventTypes.KEY_DOWN = 'keyDown';
EventTypes.KEY_UP = 'keyUp';
EventTypes.FOCUS_IN = 'focusIn';
EventTypes.FOCUS_OUT = 'focusOut';
EventTypes.CONNECT = 'connect';
EventTypes.DISCONNECT = 'disconnect';
EventTypes.DATA = 'data';
EventTypes.CLOSE = 'close';
