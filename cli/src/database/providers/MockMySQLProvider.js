...
exports.MockMySQLProvider = void 0;
const types_1 = require("../types");
class MockMySQLProvider {
    constructor(config) {
        this.name = 'MockMySQLProvider';
        this.version = '1.0.0';
        this.type = 'sql';
    ...
    async connect() {
        ...
        if (this.config.connection.host === 'invalid-host') {
            throw new types_1.ConnectionError('Failed to connect to MySQL server', 'MYSQL_CONNECTION_FAILED');
        }
        this.connected = true;
    }
    async disconnect() {
...
exports.MockMySQLProvider = MockMySQLProvider;
