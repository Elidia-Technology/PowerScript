...
class EIPSBuilder {
    ...
    private async compileTypeScript(): Promise<string> {
    ...
    private wrapForBrowser(jsContent: string): string {
...
(function() {
    ...
    private async compressJS(jsContent: string): Promise<string> {
        try {
    ...
    private generateHTML(gameInfo: GameInfo): string {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export { EIPSBuilder, BuildOptions };
export default EIPSBuilder;