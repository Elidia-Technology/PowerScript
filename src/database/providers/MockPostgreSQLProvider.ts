...
export class MockPostgreSQLProvider implements DatabaseProvider {
    public readonly name = 'MockPostgreSQLProvider';
    ...
    async connect(): Promise<void> {
        ...
        if (this.config.connection.host === 'invalid-host') {
            throw new ConnectionError('Failed to connect to PostgreSQL server', 'PG_CONNECTION_FAILED');
        }
...
class MockTransaction implements Transaction {
    ...
    constructor(
        ...
        private provider: MockPostgreSQLProvider
    ) {}
