...
export class ChartBuilder {
     ...
     */
    public async exportChart(config: ChartConfig, format: ExportFormat): Promise<Buffer> {
     ...
     */
    public getSupportedChartTypes(): ChartType[] {
    ...
    private validateConfig(config: ChartConfig): void {
    ...
    private generateLineChart(series: ChartSeries[], width: number, height: number): string {
        let chart = '';
    ...
    private generateBarChart(series: ChartSeries[], width: number, height: number): string {
        let chart = '';
        const colors = ['#3498db', '#e74c3c', '#2ecc71', '#f39c12', '#9b59b6', '#1abc9c'];
    ...
    private generateScatterChart(series: ChartSeries[], width: number, height: number): string {
        let chart = '';
        const colors = ['#3498db', '#e74c3c', '#2ecc71', '#f39c12', '#9b59b6', '#1abc9c'];
    ...
    private generatePieChart(series: ChartSeries[], width: number, height: number): string {
        let chart = '';
        const colors = ['#3498db', '#e74c3c', '#2ecc71', '#f39c12', '#9b59b6', '#1abc9c'];
    ...
    private generateAreaChart(series: ChartSeries[], width: number, height: number): string {
        let chart = '';
        const colors = ['#3498db', '#e74c3c', '#2ecc71', '#f39c12', '#9b59b6', '#1abc9c'];
    ...
    private generateHistogram(series: ChartSeries[], width: number, height: number): string {
        // Simplified histogram implementation
        return this.generateBarChart(series, width, height);
    }

    private generateAxes(config: ChartConfig, width: number, height: number): string {
        let axes = '';
    ...
    private generateLegend(series: ChartSeries[], width: number, height: number, margin: any): string {
        let legend = '';
        const colors = ['#3498db', '#e74c3c', '#2ecc71', '#f39c12', '#9b59b6', '#1abc9c'];
    ...
    private wrapInHTML(svg: string, config: ChartConfig): string {
        return `
<!DOCTYPE html>
<html>
<head>
