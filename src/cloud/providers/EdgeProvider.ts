 ...
 */
export class EdgeProvider extends BaseCloudProvider {
    ...
    private async _createResources(config: CloudConfig, deploymentId: string): Promise<CloudResource[]> {
        ...
        // Create Edge Worker
        const edgeWorker: CloudResource = {
